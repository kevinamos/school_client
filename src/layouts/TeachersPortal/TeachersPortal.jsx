...
import routes from "../../routes/teachers_portal/TeachersPortalRoutes.js";
...
class TeachersPortal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getRoutes = routes => {
    return routes.map((prop, key) => {
      ...
      if (prop.layout === "/teachers_portal") {
        return (
          <Route
...
export default withStyles(adminPageStyle)(TeachersPortal);
