...
import routes from "../../routes/student_admin/StudentAdminRoutes.js";
...
class StudentManagementAdmin extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default withStyles(adminPageStyle)(StudentManagementAdmin);
