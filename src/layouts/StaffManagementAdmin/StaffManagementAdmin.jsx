...
import routes from "../../routes/staff_admin/StaffAdminRoutes.js";
...
class StaffManagementAdmin extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default withStyles(adminPageStyle)(StaffManagementAdmin);
