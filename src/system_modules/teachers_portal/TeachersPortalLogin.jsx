...
class TeachersPortalLogin extends React.Component {
  constructor(props) {
    super(props);
  ...
  my_router = () => {
    if (!this.state.login_error) {
      this.props.history.push("/teachers_portal/teacher_select_exam");
    } else {
...
export default withStyles(loginPageStyle)(TeachersPortalLogin);
