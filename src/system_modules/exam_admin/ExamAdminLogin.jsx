...
class ExamAdminLogin extends React.Component {
  constructor(props) {
    super(props);
  ...
  my_router = () => {
    if (!this.state.login_error) {
      this.props.history.push("/exam_admin/exam_types_config");
    } else {
                ...
                <Card className={classes[this.state.cardAnimaton]}>
                  <form className={classes.form}>
                    <CardHeader color="primary" className={classes.cardHeader}>
                      <h4>Examination Administrator</h4>
...
export default withStyles(loginPageStyle)(ExamAdminLogin);
