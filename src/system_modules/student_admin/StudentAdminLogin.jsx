...
class StudentAdminLogin extends React.Component {
  constructor(props) {
    super(props);
  ...
  my_router = () => {
    if (!this.state.login_error) {
      this.props.history.push("/student_admin/student_type_categories_config");
    } else {
...
export default withStyles(loginPageStyle)(StudentAdminLogin);
