...
class WeekIterationsConfiguration extends React.Component {
constructor(props) {
    super(props);
    this.state = {
      ...
      <div>
		<Row style={{display: 'flex',  justifyContent:'center', alignItems:'center', height: '100vh'}}>
		 <Col md="6">
              <Card>
                <CardHeader>
                  <CardTitle tag="h4">Week Iterations Configuration</CardTitle>
                </CardHeader>
                <CardBody>
                  <Form className="form-horizontal" >
                    <Row>
                      ...
                      <Col md="9">
                        <FormGroup>
                          <Input placeholder="E.g Week One" type="text" name="WeekIterationDescription" value={this.state.WeekIterationDescription} type="text" onChange={this.handleChange} autofocus />
                        </FormGroup>
                      </Col>
                    </Row>
...
export default WeekIterationsConfiguration;